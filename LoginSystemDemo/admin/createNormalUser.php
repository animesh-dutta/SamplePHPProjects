...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno) values('$fname','$lname','$email','$encryptedPassword','$contact')");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Non-Admin Users</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Non Admin Users</li>
                        </ol>
                     ...
                     <div class="container">
                        ...
                        <div class="row justify-content-left">
                            <div>
								...
								<input id="isAdminYes" name="isAdmin" type="radio" value="1"/>Yes
								<input id="isAdminNo" name="isAdmin" type="radio" value="0" checked="true"/>No
								</div>
								-->
								<div class="row mb-3">
								<div class="col-md-6">
